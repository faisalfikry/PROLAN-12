	...
	public static void main(String argd[]){
       ...
       satu.setStatusKar(input.nextLine());
        ...
        case 'G':
                ...
                //pemanggilan Generic & Perhitungan
        case 'H':
               hitung.setNoBarang(input.nextLine());
               System.out.print("Kode Barang       : ");
               hitung.setNoBarang(input.nextLine());
               System.out.print("Harga Barang      : ");
               hitung.setHarga(input.nextFloat());
               System.out.print("Jumlah Barang /QTY : ");
               hitung.setJumlahBarang(input.nextInt());
               
               hitung.setBayar((hitung.Harga*hitung.JumlahBarang)-(hitung.Discon*hitung.Harga));
               hitung.TampilMenu();
               hitung.DataPembeli();
               hitung.GarisPenutup();
               break;
