...
public class MainSupermarket extends Yogya{
	...
	public static void main(String argd[]){
		...
		Yogya grand = new Yogya();
                ...
                Kerja fa = new Kerja();
                GenericBayarBarang <String>hitung1 = new GenericBayarBarang<>();
                GenericBayarBarang<Float> hitung = new GenericBayarBarang<>();
       ...
       fa.PenutupBaris();
        ...
        case 'H':
            System.out.println("\n----HITUNG BARANG----\n");
            System.out.println("Silakan Masukkan Data !");
               hitung1.setNamaPembayar(input.nextLine());
               System.out.print("Nama Barang      : ");
               hitung1.setNamaPembayar(input.nextLine());
               System.out.print("Harga Barang      : ");
               hitung.setHarga(input.nextFloat());
               System.out.print("Bayar             : ");
               hitung.setBayar(input.nextFloat());

               hitung.setKembalian(hitung.Bayar-(hitung.Harga-(hitung.Diskon*hitung.Harga)));
               hitung.TampilMenu();
               hitung.DataPembeli();
               hitung.GarisPenutup();
               System.out.print("0.Kembali Ke Menu Pilihan / E. Jika Keluar # ");
